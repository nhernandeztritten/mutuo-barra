...
- **La tira del pedido en curso** (fase 12), entre el grid y la barra del pedido. Las líneas del pedido actual en el orden de la hoja —la más reciente la última—, en filas de 44 px: la cantidad delante si es mayor que 1, el nombre, los extras en `--ink-3` y una **«×» de 44 × 44** que quita esa línea con su «Deshacer» de 8 s. Tocar el nombre la hace la bebida actual, con fondo `--surface-2` y nunca con franja lateral. Vacía, **no se dibuja**. Cuántas filas se ven **lo mide el navegador**: el hueco real entre la última bebida y el final del grid, en ranuras de 45 px, mínimo 1 y máximo 4; con más líneas, la lista se desplaza dentro de sí misma y encima va «+N más · ver todo», que ocupa una ranura. Medido: **2 filas a 402 × 874 y 1 a 402 × 781**, con el grid quieto en el mismo píxel. Para que entre, **el tile baja a 72 px por debajo de 820 px de alto** —antes 750— y el grid deja de reservar la cola de desplazamiento de 8 px en el móvil. Por tamaño de pantalla y no por si la tira está puesta: un grid que encoge al tocar la primera bebida mueve los objetivos debajo del dedo.
